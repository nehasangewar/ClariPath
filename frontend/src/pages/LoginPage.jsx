  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'DM Sans, system-ui, sans-serif' }}>
      ...
      <div className="hidden lg:flex" style={{
        ...
        <div style={{
          position: 'absolute', top: '50%', left: '50%',
          width: 290, height: 290, marginTop: -145, marginLeft: -145,
          borderRadius: '50%',
        ...
        {/* Core glow */}
        <div style={{ position: 'absolute', top: '50%', left: '50%', width: 160, height: 160, marginTop: -80, marginLeft: -80, borderRadius: '50%', background: 'radial-gradient(circle, rgba(251,191,36,0.12), rgba(180,83,9,0.04), transparent 70%)', filter: 'blur(10px)', animation: 'drift 10s ease-in-out infinite' }} />
        ...
        <div style={{
          position: 'absolute', top: 'calc(3% + 40px)', right: 'calc(-2% + 40px)',
        ...
        <div style={{ position: 'absolute', top: '5%', right: '2%', width: 120, height: 120, borderRadius: '50%', background: 'radial-gradient(circle, rgba(180,83,9,0.09), transparent)', filter: 'blur(14px)', animation: 'drift 10s ease-in-out infinite 2s' }} />
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          <h2 className="playfair" style={{ fontSize: 42, fontWeight: 900, color: C.text, lineHeight: 1.1, marginBottom: 16, letterSpacing: '-0.02em' }}>
            Welcome<br />
            <span className="gold-text">back.</span>
          </h2>

          <p style={{ fontSize: 15, color: C.textMid, lineHeight: 1.7, marginBottom: 52, maxWidth: 320 }}>
            Your personalised roadmap is waiting. Pick up exactly where you left off.
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {[
              { icon: '🗺️', text: 'Your roadmap picks up from where you left off' },
              { icon: '📊', text: 'Readiness score updated based on your progress' },
              { icon: '⚡', text: 'Next task ready the moment you sign in' },
            ].map((s, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                <div style={{ width: 36, height: 36, borderRadius: 10, background: C.goldBg, border: `1px solid ${C.goldBorder}`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: 16 }}>
                  {s.icon}
                </div>
                <span style={{ color: C.textMid, fontSize: 13, lineHeight: 1.5 }}>{s.text}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── RIGHT PANEL ── */}
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 24px', background: C.bg, overflowY: 'auto' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ marginBottom: 32 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '4px 12px', borderRadius: 100, background: C.goldBg, border: `1px solid ${C.goldBorder}`, marginBottom: 14 }}>
              ...
              <span style={{ color: C.gold, fontSize: 11, fontWeight: 600, letterSpacing: '0.04em' }}>Sign in to continue</span>
            </div>
            <h3 className="playfair" style={{ fontSize: 30, fontWeight: 900, color: C.text, marginBottom: 6, letterSpacing: '-0.02em' }}>Welcome back</h3>
            <p style={{ fontSize: 14, color: C.textLight }}>Continue your journey where you left off</p>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '24px 0' }}>
            ...
            <span style={{ fontSize: 12, color: C.textLight }}>New here?</span>
            <div style={{ flex: 1, height: 1, background: C.border }} />
          </div>
